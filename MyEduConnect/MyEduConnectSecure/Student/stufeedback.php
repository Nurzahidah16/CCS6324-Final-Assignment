...
include_once('../dbConnection.php');
 ...
 if(isset($_REQUEST['submitFeedbackBtn'])){
  if(($_REQUEST['f_content'] == "")){
   ...
   // FIX: Sanitize input data to prevent XSS payloads from storing dangerous HTML/JS tags
   $fcontent = htmlspecialchars($_REQUEST["f_content"], ENT_QUOTES, 'UTF-8');
 ...
 <div class="col-sm-6 mt-5">
  <form class="mx-5" method="POST" enctype="multipart/form-data">
    <div class="form-group">
      ...
      <input type="text" class="form-control" id="stuId" name="stuId" value="<?php if(isset($stuId)) { echo htmlspecialchars($stuId, ENT_QUOTES, 'UTF-8'); } ?>" readonly>
    </div>
    <div class="form-group">
