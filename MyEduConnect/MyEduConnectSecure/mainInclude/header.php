...
<html lang="en">
  <head>
    ...
    <title>MyEduConnect</title>
  </head>
  <body>
    <!-- Start Navigation -->
    <nav class="navbar navbar-expand-sm navbar-dark pl-5 fixed-top">
      <a href="index.php" class="navbar-brand">MyEduConnect</a>
      ...
      <div class="collapse navbar-collapse" id="myMenu">
        <ul class="navbar-nav pl-5 custom-nav">
          ...
          <li class="nav-item custom-nav-item">
            <a href="#parentlogin" class="nav-link" data-toggle="modal" data-target="#parentLoginModal">Parent Portal</a>
          </li>
        ...
        <!-- Not Secure Website Button -->
        <a href="/MyEduConnect/MyEduConnectInsecure/index.php" class="btn btn-danger ml-auto">
          Not Secure 
        </a>
      </div>
    </nav>
