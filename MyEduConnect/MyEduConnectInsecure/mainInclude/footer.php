 ...
 <footer class="container-fluid bg-dark text-center p-2">
    <small class="text-white">Copyright &copy; 2026 || Designed By EduConnect || <?php   
...
<div class="modal fade" id="parentLoginModal" tabindex="-1" role="dialog">
  <div class="modal-dialog modal-dialog-centered" role="document">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="Parent/parentLogin.php" method="POST">
