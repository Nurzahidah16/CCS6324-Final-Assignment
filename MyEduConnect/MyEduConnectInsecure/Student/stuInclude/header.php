...
<body>
 ...
 <nav class="navbar navbar-dark fixed-top flex-md-nowrap p-0 shadow" style="background-color: #225470;">
  <a class="navbar-brand col-sm-3 col-md-2 mr-0" href="studentProfile.php">EduConnect</a>
 </nav>
     ...
     <ul class="nav flex-column">
      ...
      <li class="nav-item">
       <a class="nav-link <?php if(PAGE == 'mycourse') {echo 'active';} ?>" href="myCourse.php">
        ...
        <li class="nav-item">
<a class="nav-link <?php if(PAGE == 'browsecourse') {echo 'active';} ?>" href="../../MyEduConnect/courses.php">
